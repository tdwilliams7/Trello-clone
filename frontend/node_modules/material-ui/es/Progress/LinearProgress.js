...
function LinearProgress(props) {
  ...
  if (mode === 'determinate' || mode === 'buffer') {
    if (value !== undefined) {
      ...
      warning(false, 'Material-UI: you need to provide a value property ' + 'when LinearProgress is in determinate or buffer mode.');
    }
  }
  if (mode === 'buffer') {
    if (valueBuffer !== undefined) {
      ...
      warning(false, 'Material-UI: you need to provide a valueBuffer property ' + 'when LinearProgress is in buffer mode.');
    }
  }
